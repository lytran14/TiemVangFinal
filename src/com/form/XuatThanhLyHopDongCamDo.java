...
public class XuatThanhLyHopDongCamDo extends javax.swing.JFrame {

    private FormCamDo formCamDo;

    public XuatThanhLyHopDongCamDo(FormCamDo form) {
        initComponents();
    ...
    void init(FormCamDo form1) {
        ...
        html += "<h1 style='text-align: center;'>THANH LÝ HỢP ĐỒNG CẦM ĐỒ<br></h1>";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                XuatThanhLyHopDongCamDo xuatCDo = new XuatThanhLyHopDongCamDo(form1); // Truyền tham chiếu của FormMuaVao
